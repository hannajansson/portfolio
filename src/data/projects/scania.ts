...
export const scania: Project = {
  ...
  description:
    'Scania sought to create a structured and scalable Help Center to empower customers with autonomy, clarity, and control over their digital experience. The initiative aimed to reduce dependency on support, alleviate pressure on sales and support teams, and ensure consistently up-to-date content across global markets.',
  client: 'Scania',
  year: '2023',
  industry: 'Automotive',
  role: 'Product Owner & Service Designer',
  ...
  sections: [
    {
      type: 'text-image',
      title: 'The Challenge',
      text: 'The challenge was real — shifting between hats while owning a product pre- and post-launch feedback, collaboration and planning, development responsibility. Navigating a premium-focused enterprise while balancing stakeholder and market expectations.',
    ...
    },
    {
      ...
      image: '',            // add image path here
      imageAlt: 'Scania Help Center search result',
      imagePosition: 'right',
    },
    {
      type: 'full-image',
